...
>[Open Code for this Activity](Programs/01VIP.py)
...
>[Open Code for this Activity](Programs/02LogicBouncer.py)
...
evens: Should contain all even numbers from the original list.
cleaned: Should contain only positive numbers (greater than 0).
